...
const file_apiserver_v1_apiserver_proto_rawDesc = "" +
	...
	"\f博客管理\x12\x12列出所有文章*\bListPost\x82\xd3\xe4\x93\x02\v\x12\t/v1/postsB\x80\x02\x92A\xce\x01\x12\xa4\x01\n" +
	"\fminiblog API\"N\n" +
	"\x18小而美的博客项目\x12\x1chttps://example.com/miniblog\x1a\x14colin404@foxmail.com*?\n" +
	"\vMIT License\x120https://example.com/miniblog/blob/master/LICENSE2\x031.0*\x01\x022\x10application/json:\x10application/jsonZ,example.com/miniblog/pkg/api/apiserver/v1;v1b\x06proto3"
